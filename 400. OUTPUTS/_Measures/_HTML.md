...
<div class='container'>
    ...
    <div class='summary-stats'>
        <div class='stat-box'>
            ...
            <div class='stat-value'><span id='completedCount'>0</span> / 6</div>
        </div>
        <div class='stat-box'>
            <div class='stat-label'>Wynik</div>
            <div class='stat-value'><span id='percentageScore'>0</span>%</div>
        </div>
    </div>
    ...
    <div class='button-group'>
        <button onclick='resetAllTasks()' style='width: 100%;'>🔄 Rozpocznij od nowa</button>
    </div>
</div>
</div>
...
<div class='container'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Pytanie <span id='currentPage'>1</span> z <span id='totalPages'>6</span>
        </span>
    ...
    <div class='page'>
        <h1>Pytanie 5</h1>
        <div class='question-box'>
            <p><strong>Czym różni się <code>COUNT</code> od <code>COUNTROWS</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
                A) <code>COUNT</code> liczy kolumny, <code>COUNTROWS</code> liczy wiersze
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 1)'>
                B) <code>COUNT</code> liczy niepuste wartości w kolumnie, <code>COUNTROWS</code> liczy wszystkie wiersze tabeli
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 2)'>
                C) Nie ma różnicy
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 3)'>
                D) <code>COUNT</code> jest szybsze niż <code>COUNTROWS</code>
            </div>
        </div>
    ...
    <div class='page'>
        <h1>Pytanie 6</h1>
        <div class='question-box'>
            <p><strong>Co robi funkcja <code>DISTINCTCOUNT</code>?</strong></p>
        </div>
        <div class='answers'>
...
<div class='container'>
    ...
    <div class='page'>
        ...
        <div class='answers'>
            ...
            <div class='answer-option' onclick='selectAnswer(5, 3)'>
                D) Tylko w funkcji <code>CALCULATE</code>
            </div>
        </div>
...
<div class='container'>
    ...
    <div class='page active'>
        <h1>Pytanie 1</h1>
        <div class='question-box'>
            <p><strong>Do czego służy funkcja <code>CALCULATE</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(0, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 2</h1>
        <div class='question-box'>
            <p><strong>Jaka jest podstawowa składnia funkcji <code>CALCULATE</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(1, 0)'>
                A) <code>CALCULATE(wyrażenie, filtr1, filtr2, ...)</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 1)'>
                B) <code>CALCULATE(tabela, warunek)</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 2)'>
                C) <code>CALCULATE(kolumna = wartość)</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 3)'>
                D) <code>CALCULATE(miara + filtr)</code>
            </div>
        </div>
    ...
    <div class='page'>
        <h1>Pytanie 3</h1>
        <div class='question-box'>
            <p><strong>Co zrobi <code>CALCULATE</code> bez żadnych filtrów:<code> CALCULATE([Suma Sprzedaży])</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(2, 0)'>
                A) Zwróci błąd
            ...
            <div class='answer-option' onclick='selectAnswer(2, 1)'>
                B) Zwróci wartość identyczną jak <code>[Suma Sprzedaży]</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 2)'>
    ...
    <div class='page'>
        ...
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(3, 0)'>
                A) <code>CALCULATE([Suma], Produkty[Kategoria] = ″Elektronika″)</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(3, 1)'>
                B) <code>CALCULATE([Suma], FILTER(Produkty, ″Elektronika″))</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(3, 2)'>
                C) <code>CALCULATE([Suma] WHERE Kategoria = ″Elektronika″)</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(3, 3)'>
                D) <code>SUM(Produkty[Sprzedaż], ″Elektronika″)</code>
            </div>
        </div>
    ...
    <div class='page'>
        <h1>Pytanie 5</h1>
        <div class='question-box'>
            <p><strong>Czy w <code>CALCULATE</code> możesz zastosować wiele filtrów jednocześnie?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
            ...
            <div class='answer-option' onclick='selectAnswer(4, 1)'>
                B) Tak, <code>CALCULATE</code> nie ma zdefiniowanej liczby parametrów
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 2)'>
                C) Tak, filtry są łączone operatorem <code>OR</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 3)'>
    ...
    <div class='page'>
        <h1>Pytanie 6</h1>
        <div class='question-box'>
            <p><strong>Co robi funkcja <code>FILTER</code> w połączeniu z <code>CALCULATE</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(5, 0)'>
...
<div class='container'>
    <div class='task-description'>
        ...
        Jaka jest różnica między <code>ALL</code> a <code>REMOVEFILTERS</code> w kontekście <code>CALCULATE</code>?
    </div>
...
<div class='container'>
    <div class='task-description'>
        ...
        Chcesz usunąć wszystkie filtry z tabeli <code>dProdukt</code>, OPRÓCZ filtra na <code>Kategoria</code>. Jakiej funkcji użyć?
    </div>
...
<div class='container'>
    ...
    <div class='page'>
        <h1>Pytanie 2</h1>
        <div class='question-box'>
            <p><strong>Jaka jest różnica między <code>ALL(Tabela)</code> a <code>ALL(Tabela[Kolumna])</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(1, 0)'>
                A) Nie ma różnicy
            ...
            <div class='answer-option' onclick='selectAnswer(1, 1)'>
                B) <code>ALL(Tabela)</code> usuwa filtry z całej tabeli, <code>ALL(Tabela[Kolumna])</code> tylko z jednej kolumny
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 2)'>
                C) <code>ALL(Tabela)</code> jest szybsze
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 3)'>
                D) <code>ALL(Tabela[Kolumna])</code> usuwa także relacje
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(1, 1)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-1'></div>
    ...
    <div class='page'>
        <h1>Pytanie 3</h1>
        <div class='question-box'>
            <p><strong>Jaka jest nowoczesna alternatywa dla funkcji <code>ALL</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(2, 0)'>
                A) <code>CLEARFILTERS</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 1)'>
                B) <code>REMOVEFILTERS</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 2)'>
                C) <code>DELETEFILTERS</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 3)'>
                D) <code>NOFILTERS</code>
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(2, 1)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-2'></div>
    ...
    <div class='page'>
        <h1>Pytanie 4</h1>
        <div class='question-box'>
            <p><strong>Co oblicza: <code>CALCULATE([Sprzedaż], ALL(Produkty))</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(3, 0)'>
    ...
    <div class='page'>
        ...
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
                A) <code>[Sprzedaż] / SUM(Sprzedaż)</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 1)'>
                B) <code>[Sprzedaż] / CALCULATE([Sprzedaż], ALL(Tabela))</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 2)'>
                C) <code>DIVIDE([Sprzedaż], [Całkowita Sprzedaż])</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 3)'>
                D) <code>Zarówno B jak i C (gdy [Całkowita Sprzedaż] używa ALL)</code>
            </div>
        </div>
    ...
    <div class='page'>
        <h1>Pytanie 6</h1>
        <div class='question-box'>
            <p><strong>Co robi funkcja <code>ALLSELECTED</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(5, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 7</h1>
        <div class='question-box'>
            <p><strong>Kiedy używamy <code>KEEPFILTERS</code> w <code>CALCULATE</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(6, 0)'>
...
<div class='container'>
    ...
    <div class='page active'>
        <h1>Pytanie 1</h1>
        <div class='question-box'>
            <p><strong>Do czego służy słowo kluczowe <code>VAR</code> w DAX?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(0, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 2</h1>
        <div class='question-box'>
            <p><strong>Ile razy może wystąpić słowo <code>RETURN</code> w jednej mierze DAX?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(1, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 3</h1>
        <div class='question-box'>
            <p><strong>Co się stanie ze zmiennymi <code>VAR</code> wewnątrz funkcji iteracyjnej jak <code>SUMX</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(2, 0)'>
            ...
            <div class='answer-option' onclick='selectAnswer(2, 2)'>
                C) Nie można używać <code>VAR</code> wewnątrz funkcji iteracyjnych
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 3)'>
    ...
    <div class='page'>
        <h1>Pytanie 5</h1>
        <div class='question-box'>
            <p><strong>Jakie są główne zalety używania zmiennych <code>VAR</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 7</h1>
        <div class='question-box'>
            <p><strong>Co może zawierać zmienna <code>VAR</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(6, 0)'>
                A) Tylko liczby
...
<div class='container'>
    ...
    <div class='page'>
        <h1>Pytanie 2</h1>
        <div class='question-box'>
            <p><strong>Co zwraca funkcja <code>SUMMARIZECOLUMNS</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(1, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 3</h1>
        <div class='question-box'>
            <p><strong>Jaka jest podstawowa składnia <code>SUMMARIZECOLUMNS</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(2, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 4</h1>
        <div class='question-box'>
            <p><strong>Dlaczego <code>SUMMARIZE</code> jest uznawana za legacy (przestarzałą)?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(3, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 5</h1>
        <div class='question-box'>
            <p><strong>Czy w <code>SUMMARIZECOLUMNS</code> możesz dodać wiele miar?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 6</h1>
        <div class='question-box'>
            <p><strong>Do czego służy funkcja <code>ADDCOLUMNS</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(5, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 7</h1>
        <div class='question-box'>
            <p><strong>Jaki jest wynik: <code>SUMMARIZECOLUMNS(Produkty[Kategoria], ´Suma´, [Sprzedaż])</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(6, 0)'>
...
<div class='container'>
    ...
    <div class='hint-box'>
        Funkcje iteracyjne w DAX kończą się literą <code>X</code>. Szukaj funkcji, która najpierw mnoży wartości w każdym wierszu, a potem je sumuje.
    </div>
...
<div class='container'>
    ...
    <div class='hint-box'>
        Potrzebujesz funkcji iteracyjnej, która liczy ile razy wyrażenie zwróciło niepustą wartość. Funkcja ta kończy się literą <code>X</code> i zaczyna od <code>COUNT</code>.
    </div>
...
<div class='container'>
    ...
    <div class='page active'>
        <h1>Pytanie 1</h1>
        <div class='question-box'>
            <p><strong>Co jest kluczową cechą funkcji iteracyjnych takich jak <code>SUMX</code> czy <code>AVERAGEX</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(0, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 2</h1>
        <div class='question-box'>
            <p><strong>Dlaczego wzór <code>SUM(Sprzedaz[Cena]) * SUM(Sprzedaz[Ilość])</code> daje błędny wynik dla obliczenia wartości zamówień?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(1, 0)'>
                A) Funkcja <code>SUM</code> nie obsługuje mnożenia
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 1)'>
            ...
            <div class='answer-option' onclick='selectAnswer(1, 3)'>
                D) Należy użyć funkcji <code>CALCULATE</code> zamiast <code>SUM</code>
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(1, 2)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-1'></div>
    ...
    <div class='page'>
        ...
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(2, 0)'>
                A) <code>AVERAGE(Sprzedaz[Wartość Netto] - Sprzedaz[Koszty Netto])</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 1)'>
                B) <code>AVERAGEX(Sprzedaz, Sprzedaz[Wartość Netto] - Sprzedaz[Koszty Netto])</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 2)'>
                C) <code>SUMX(Sprzedaz, Sprzedaz[Wartość Netto] - Sprzedaz[Koszty Netto]) / COUNT(Sprzedaz[Wartość Netto])</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 3)'>
                D) <code>CALCULATE(AVERAGE(Sprzedaz[Wartość Netto] - Sprzedaz[Koszty Netto]))</code>
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(2, 1)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-2'></div>
    ...
    <div class='page'>
        <h1>Pytanie 5</h1>
        <div class='question-box'>
            <p><strong>Co zwróci funkcja <code>COUNTX(Sprzedaz, IF(Sprzedaz[Wartość Netto] > 1000, 1, BLANK()))</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
            ...
            <div class='answer-option' onclick='selectAnswer(4, 1)'>
                B) Liczbę wierszy w tabeli <code>Sprzedaz</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 2)'>
                C) Liczbę zamówień, których Wartość Netto przekracza 1000
            </div>
            <div class='answer-option' onclick='selectAnswer(4, 3)'>
                D) Wartość logiczną <code>TRUE</code> lub <code>FALSE</code>
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(4, 2)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-4'></div>
...
<div class='container'>
    ...
    <div class='navigation'>
        <button id='prevBtn' onclick='changePage(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Pytanie <span id='currentPage'>1</span> z <span id='totalPages'>9</span>
        </span>
        <button id='nextBtn' onclick='changePage(1)'>Następna →</button>
    </div>
    ...
    <div class='page active'>
        ...
        <div class='answers'>
            ...
            <div class='answer-option' onclick='selectAnswer(0, 3)'>
                D) Należy użyć funkcji <code>CALENDAR</code> w każdej mierze
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(0, 1)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-0'></div>
    ...
    <div class='page'>
        <h1>Pytanie 2</h1>
        <div class='question-box'>
            <p><strong>Co zmieni dodanie <code>TOTALYTD</code> do funkcji <code>SUM</code> w <code>CALCULATE</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(1, 0)'>
                A) <code>TOTALYTD</code> sumuje wartości szybciej niż <code>SUM</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 1)'>
                B) <code>TOTALYTD</code> oblicza sumę skumulowaną od początku roku do bieżącej daty w kontekście filtra
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 2)'>
                C) <code>TOTALYTD</code> działa tylko na kolumnach tekstowych
            </div>
            <div class='answer-option' onclick='selectAnswer(1, 3)'>
                D) <code>TOTALYTD</code> nie wymaga tabeli dat w modelu
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(1, 1)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-1'></div>
    ...
    <div class='page'>
        ...
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(2, 0)'>
                A) <code>CALCULATE(SUM(Sprzedaz[Wartość]), DATEADD(Kalendarz[Data], 1, YEAR))</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 1)'>
                B) <code>CALCULATE(SUM(Sprzedaz[Wartość]), SAMEPERIODLASTYEAR(Kalendarz[Data]))</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 2)'>
                C) <code>SUM(Sprzedaz[Wartość]) - 365</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(2, 3)'>
                D) <code>TOTALYTD(SUM(Sprzedaz[Wartość]), Kalendarz[Data], -1)</code>
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(2, 1)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-2'></div>
    ...
    <div class='page'>
        <h1>Pytanie 4</h1>
        <div class='question-box'>
            <p><strong>Co zwróci miara <code>CALCULATE(SUM(Sprzedaz[Wartość]), DATESBETWEEN(Kalendarz[Data], DATE(2024,1,1), DATE(2024,3,31)))</code> gdy jest użyta w tabeli z podziałem na miesiące?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(3, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 5</h1>
        <div class='question-box'>
            <p><strong>Co się stanie, gdy użyjesz <code>TOTALMTD(SUM(Sprzedaz[Wartość]), Kalendarz[Data])</code> w kontekście, gdzie wybrany jest koniec miesiąca?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(4, 0)'>
    ...
    <div class='page'>
        <h1>Pytanie 6</h1>
        <div class='question-box'>
            <p><strong>Co zwróci funkcja <code>PARALLELPERIOD(Kalendarz[Data], -4, QUARTER)</code> gdy bieżący kontekst to Q3 2024?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(5, 0)'>
                A) Q2 2024
    ...
    <div class='page'>
        <h1>Pytanie 7</h1>
        <div class='question-box'>
            <p><strong>Dlaczego wzór <code>SUM(Sprzedaz[Wartość]) / CALCULATE(SUM(Sprzedaz[Wartość]), ALL(Kalendarz))</code> może nie dać prawidłowego udziału procentowego w kontekście roku?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(6, 0)'>
                A) Funkcja <code>ALL</code> usuwa wszystkie filtry, więc mianownik zawsze pokazuje sumę globalną zamiast rocznej
            </div>
            <div class='answer-option' onclick='selectAnswer(6, 1)'>
                B) Należy użyć funkcji <code>DIVIDE</code> zamiast operatora <code>/</code>
            </div>
            <div class='answer-option' onclick='selectAnswer(6, 2)'>
                C) Funkcja <code>SUM</code> nie może być użyta dwukrotnie w jednej mierze
            </div>
            <div class='answer-option' onclick='selectAnswer(6, 3)'>
                D) Brakuje funkcji <code>TOTALYTD</code> w liczniku
            </div>
        </div>
        <button class='check-button' onclick='checkAnswer(6, 0)'>Sprawdź odpowiedź</button>
        <div class='feedback' id='feedback-6'></div>
    ...
    <div class='page'>
        <h1>Pytanie 8</h1>
        <div class='question-box'>
            <p><strong>Jaka jest różnica między <code>DATEADD</code> a <code>PARALLELPERIOD</code>?</strong></p>
        </div>
        <div class='answers'>
            <div class='answer-option' onclick='selectAnswer(7, 0)'>
                A) <code>DATEADD</code> może przesuwać o dni, miesiące, kwartały i lata, a <code>PARALLELPERIOD</code> tylko o lata
            </div>
            <div class='answer-option' onclick='selectAnswer(7, 1)'>
                B) <code>DATEADD</code> przesuwa każdą datę osobno, a <code>PARALLELPERIOD</code> przesuwa cały okres jako całość
            </div>
            <div class='answer-option' onclick='selectAnswer(7, 2)'>
                C) <code>PARALLELPERIOD</code> działa szybciej niż <code>DATEADD</code>
            </div>
    ...
    <div class='page'>
        <h1>Pytanie 9</h1>
        <div class='question-box'>
            <p><strong>Co zrobi funkcja <code>FIRSTDATE</code> w kontekście tabeli z podziałem na miesiące?</strong></p>
        </div>
        <div class='answers'>

createOrReplace
    ...
    table _HTML
        lineageTag: eec9bd02-ff9f-47e2-ad5f-5cb8b8c1d2a8

        measure 'Funkcje filtrujące' = ```
"
...
<div class='container'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage'>1</span> z <span id='totalPages'>2</span>
        </span>
...
"
```
            lineageTag: a933dc65-09a5-438c-a6f0-67805ce7d609

        measure 'Funkcje iteracyjne (X-functions)' = ```
"
...
<div class='container'>
    ...
    <div class='navigation'>
        <button id='prevBtn' onclick='changePage(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Strona <span id='currentPage'>1</span> z <span id='totalPages'>4</span>
        </span>
        <button id='nextBtn' onclick='changePage(1)'>Następna →</button>
    </div>
...
"
```
            lineageTag: e5ac7257-78cc-4dce-96b5-9b847b41caa1

        measure 'Podstawowe funkcje agregujące' = ```
"
...
<div class='container'>
    ...
    <div class='navigation'>
        <button id='prevBtn' onclick='changePage(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Strona <span id='currentPage'>1</span> z <span id='totalPages'>7</span>
        </span>
        <button id='nextBtn' onclick='changePage(1)'>Następna →</button>
    </div>
...
"
```
            lineageTag: 6eb22c8c-3911-418e-a08b-556549764ab3

        measure 'Podstawowe funkcje dat' = ```
"
...
"
```
            lineageTag: 65d0f91c-24fb-4b6b-a4a3-07f38c419255

        measure 'Podstawowe funkcje logiczne' = ```
"
...
"
```
            lineageTag: 9f9c0901-14cd-408d-a87c-7cf82837a6de

        measure 'Podstawowe funkcje tekstowe' = ```
"
...
"
```
            lineageTag: e6f767a1-2877-44ef-ae9b-53c143ca68fc

        measure 'Wprowadzenie do CALCULATE' = ```
"
...
<div class='container'>
    ...
    <div class='navigation'>
        <button id='prevBtn' onclick='changePage(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Strona <span id='currentPage'>1</span> z <span id='totalPages'>9</span>
        </span>
        <button id='nextBtn' onclick='changePage(1)'>Następna →</button>
    </div>
...
"
```
            lineageTag: 3508e7b0-42ea-42b2-86eb-5124521811e6

        measure 'Podstawy DAX' = ```
"
...
<div class='container'>
    ...
    <div class='navigation'>
        <button id='prevBtn' onclick='changePage(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Strona <span id='currentPage'>1</span> z <span id='totalPages'>10</span>
        </span>
        <button id='nextBtn' onclick='changePage(1)'>Następna →</button>
    </div>
...
"
```
            lineageTag: 41c5df07-a946-4593-a570-27ea189105f9
...
"
```
            lineageTag: ca911427-3b01-422c-ba87-0aec0619e3c0

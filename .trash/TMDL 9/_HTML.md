createOrReplace
    ...
    table _HTML
        lineageTag: 49b56e76-2863-400f-baad-01fecf254992
...
"
```
            lineageTag: 0bab3e3e-c216-451f-b28b-64fb7b06375d
...
"
```
            lineageTag: 5c399afc-e4b1-4fdf-8038-7aa69a38bc07
...
"
```
            lineageTag: 5db2a1dc-3bcb-4467-b869-6bf99ca39f4c
...
"
```
            lineageTag: bf76de5a-ea55-4d21-bd3e-cd5ad65f58f6
...
"
```
            lineageTag: d7c9da78-f113-4ae2-b172-a0f834a4f295
...
"
```
            lineageTag: 9314b3ac-ba94-4419-a6c2-7eaa5ffda1e0
...
"
```
            lineageTag: ac95d449-8cd3-41f4-8b79-55bef6f6442e
...
"
```
            lineageTag: 3107b5e6-9121-478a-b998-6582069e364b
...
"
```
            lineageTag: d18d1123-dbd3-4bf1-8f82-b27118ee0851
...
"
```
            lineageTag: 4dc8ed57-1e36-42e7-a8ff-4fa1cb8e1c71
...
"
```
            lineageTag: ef415a05-440f-4533-aea9-e7e118c431df
...
"
```
            lineageTag: 0de322ec-a0c9-419d-b875-6c5053db04cf
...
"
```
            lineageTag: 6789baad-676a-4d4d-93e9-7ff1cbc2d5f4
...
"
```
            lineageTag: c976c9e8-904a-4763-a72a-f4a466e6a252
...
"
```
            lineageTag: e6fc2bfc-57fd-4543-9a0b-597d52816d62
...
"
```
            lineageTag: a7e5e103-4807-47f6-b3fc-a97ab68668c2
...
"
```
            lineageTag: 7c240490-d506-4c02-bb11-3943a98a532a
...
"
```
            lineageTag: 218a537f-5eff-4f72-bd2a-3c5f66576e2b
...
"
```
            lineageTag: 95be1e08-dbd7-4da1-9210-a5dd402dc478
...
"
```
            lineageTag: 8a50a74a-9bb9-4fca-be09-21a2d21d4d68
...
"
```
            lineageTag: d78abf03-9600-4ee7-b02e-a679728f1e09
...
"
```
            lineageTag: 11ee3d60-ca18-4046-bdb8-c8eff6ea9c01
...
"
```
            lineageTag: fd9572fa-d651-42ee-ad59-a6cabbd96b4c
...
"
```
            lineageTag: e71c2f8e-49be-4b21-8c25-80f34b0bfec1
...
"
```
            lineageTag: 3d16e3a1-d168-4e96-bbee-bf1a1de5c22f
...
"
```
            lineageTag: 354050f1-ef9e-4690-97a1-898a3b20959e
...
"
```
            lineageTag: d5db25cc-8cee-4438-a321-30b4d0be4982
...
"
```
            lineageTag: 263af557-fcc0-494d-b82e-746fe060eb6c
...
"
```
            lineageTag: b1697aac-ab6f-45b3-b588-9962fd0b1466
...
"
```
            lineageTag: 11fd72da-c347-46c6-a721-b25906414049
...
"
```
            lineageTag: 81f8588a-d99a-4e5b-ba8f-b6c490635132
...
"
```
            lineageTag: aa753e20-cf44-48e3-9ba3-60b0f9410756
...
"
```
            lineageTag: 80c93ba8-49ea-4b30-88af-94ccf1427243
...
"
```
            lineageTag: 07b7ce63-a195-4d5f-aae4-41133128d8f1
...
"
```
            lineageTag: d901d62c-235f-402d-a9fb-ddb10fce3b5b
...
"
```
            lineageTag: a253af8d-8e81-457d-b2ad-e0f8dccb2a1d
...
"
```
            lineageTag: c0b140f2-dd92-4fb9-878d-41bc82987ae2
...
"
```
            lineageTag: 3f0747f6-7e68-441c-9426-707c27e3408c
...
"
```
            lineageTag: 2a552071-a06d-4983-b75f-92683b68bcaf
...
"
```
            lineageTag: 889d52d8-dc91-4e65-bff9-4a93098ff5cd
...
<div class='container'>
    <div class='task-description'>
        <h3>Podstawowa skladnia SUMX</h3>
        Ktore funkcje poprawnie uzupelniaja skladnie funkcji iteracyjnej obliczajacej calkowita wartosc sprzedazy?
    </div>
    ...
    <div class='hint-box'>
        Funkcje iteracyjne w DAX koncza sie litera X. Szukaj funkcji, ktora najpierw mnozy wartosci w kazdym wierszu, a potem je sumuje.
    </div>
...
<div class='container'>
    <div class='task-description'>
        <h3>Obliczanie marzy z AVERAGEX</h3>
        Ktora funkcja pozwoli obliczyc srednia marze dla kazdego wiersza transakcji?
    </div>
    ...
    <div class='hint-box'>
        Potrzebujesz funkcji iteracyjnej, ktora obliczy roznice dla kazdego wiersza, a nastepnie zwroci srednia arytmetyczna tych wartosci.
    </div>
...
<div class='container'>
    <div class='task-description'>
        ...
        Ktora funkcja pozwoli policzyc zamowienia powyzej 1000 PLN wykonujac sprawdzenie dla kazdego wiersza?
    </div>
    ...
    <div class='hint-box'>
        Potrzebujesz funkcji iteracyjnej, ktora liczy ile razy wyrazenie zwrocilo niepusta wartosc. Funkcja ta konczy sie litera X i zaczyna od COUNT.
    </div>
...
<script>
    let currentPage = 1;
    const totalPages = 3;
    const slotsPerPage = [0, 0, 0];
    let slots = new Array(slotsPerPage[0]).fill('');
    const correctSolutions = [[], [], []];
    const correctFeedback = ['\u2705Brawo!\nSUMX to funkcja iteracyjna, ktora przechodzi przez kazdy wiersz tabeli Sprzedaz, mnozy Cene przez Ilosc dla kazdego wiersza osobno, a nastepnie sumuje wszystkie wyniki.', '\u2705Brawo!\nAVERAGEX iteruje przez kazdy wiersz tabeli Sprzedaz, oblicza marze dla kazdej transakcji odejmujac Koszty od Wartosci Netto, a nastepnie oblicza srednia z wszystkich wynikow.', '\u2705Brawo! \nCOUNTX iteruje przez kazdy wiersz tabeli Sprzedaz, sprawdza warunek dla kazdego wiersza osobno i liczy ile razy wyrazenie zwrocilo niepusta wartosc. Gdy Wartosc Netto przekracza 1000, funkcja IF zwraca 1, ktore jest liczone.'];
    const incorrectFeedback = [{}, {}, {}];
...
"
```
            lineageTag: 3c7dab70-43e3-49a0-95e4-629895a3bcb6
...
"
```
            lineageTag: d6cadea3-07ff-4c6c-92cd-7040977afac0
...
"
```
            lineageTag: a40e3661-d81a-4a94-8146-bd10f61f3a71
...
"
```
            lineageTag: cfb4c64e-8122-4152-a11e-e69ddbf2f700
...
"
```
            lineageTag: 02fe99c0-6de3-4962-aee6-1ab6921f09e7
...
"
```
            lineageTag: 9eddd856-4f2a-422a-88b4-a5a7114e975e
...
"
```
            lineageTag: a23abeb8-5342-4811-aed4-46aa6c316f48
...
"
```
            lineageTag: 2eddb83d-3da4-4e91-bc7d-cf26e355049b
...
"
```
            lineageTag: 5995cce4-36ce-49c4-ad33-a53f6e003143

createOrReplace
    ...
    table _HTML
        lineageTag: c353f418-d8f8-49bb-bb1e-2ca4d90968b6
...
"
```
            lineageTag: 1ecbcf68-6e8e-4b21-8258-14cb6be24b4e
...
"
```
            lineageTag: 3d08774f-5ffb-45db-825c-3c60a5aadde5
...
<div class='container'>
    <div class='task-description'>
        <h3>Separator argumentów w DAX</h3>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Przecinek'>Przecinek</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Średnik'>Średnik</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Dwukropek'>Dwukropek</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Kropka'>Kropka</span>
    </div>

    <div class='code-container'>
        <div>DAX</div>
        <div>Suma wartości = SUMX(fDemo<div class='drop-zone' data-slot='0' ondrop='drop(event)' ondragover='allowDrop(event)' ondragleave='dragLeave(event)'></div> fDemo[Price] * fDemo[Quantity])</div>
    </div>
...
<div class='container'>
    <div class='task-description'>
        <h3>Wyłączenie automatycznego wykrywania typów</h3>
        Chcesz mieć pełną kontrolę nad typami danych w Power Query i wyłączyć automatyczne wykrywanie. Gdzie znajdziesz tę opcję?
    </div>

    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='GLOBALNE'>GLOBALNE</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='BIEŻĄCY PLIK'>BIEŻĄCY PLIK</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Power Query'>Power Query</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Ładowanie danych'>Ładowanie danych</span>
    </div>

    <div class='code-container'>
        <div>Plik → Opcje i ustawienia → Opcje → <div class='drop-zone' data-slot='0' ondrop='drop(event)' ondragover='allowDrop(event)' ondragleave='dragLeave(event)'></div> → <div class='drop-zone' data-slot='1' ondrop='drop(event)' ondragover='allowDrop(event)' ondragleave='dragLeave(event)'></div></div>
        <div>Odznacz: Automatycznie wykrywaj typy kolumn...</div>
    </div>
...
<div class='container'>
    <div class='task-description'>
        <h3>Widok DAX Query</h3>
        W którym widoku Power BI możesz pisać i testować zapytania DAX bez tworzenia miar w modelu?
    </div>

    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Widok Raport'>Widok Raport</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Widok Model'>Widok Model</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Widok DAX Query'>Widok DAX Query</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Widok Dane'>Widok Dane</span>
    </div>

    <div class='code-container'>
        <div>DAX</div>
        <div>-- Ten kod możesz wykonać w: <div class='drop-zone' data-slot='0' ondrop='drop(event)' ondragover='allowDrop(event)' ondragleave='dragLeave(event)'></div></div>
        <div>EVALUATE</div>
        <div>SUMMARIZECOLUMNS(</div>
        <div>    fDemo[Category],</div>
        <div>    Total Sales, SUMX(fDemo, fDemo[Price] * fDemo[Quantity])</div>
        <div>)</div>
    </div>
...
<script>
    let currentPage = 1;
    const totalPages = 3;
    const slotsPerPage = [1, 2, 1];
    let slots = new Array(slotsPerPage[0]).fill('');
    const correctSolutions = [['Przecinek'], ['BIE\u017b\u0104CY PLIK', '\u0141adowanie danych'], ['Widok DAX Query']];
    const correctFeedback = ['\u2705 **Brawo! Rozwi\u0105zanie poprawne!**\nW polskiej wersji Power BI separator argument\u00f3w to \u015brednik, a separator dziesi\u0119tny to przecinek. Przyk\u0142ad: SUMX(fDemo, fDemo[Price] * fDemo[Quantity]). W angielskiej wersji jest odwrotnie - separator argument\u00f3w to przecinek, a dziesi\u0119tny to kropka.', '\u2705 **Brawo! Rozwi\u0105zanie poprawne!**\nOpcja automatycznego wykrywania typ\u00f3w znajduje si\u0119 w: Plik \u2192 Opcje i ustawienia \u2192 Opcje \u2192 BIE\u017b\u0104CY PLIK \u2192 \u0141adowanie danych. Nale\u017cy tam odznaczy\u0107 opcj\u0119 Automatycznie wykrywaj typy kolumn i nag\u0142\u00f3wki dla \u017ar\u00f3de\u0142 nieustrukturyzowanych. To ustawienie dotyczy konkretnego pliku .pbix, nie globalnie ca\u0142ego Power BI.', '\u2705 **Brawo! Rozwi\u0105zanie poprawne!**\nWidok DAX Query pozwala na pisanie i testowanie zapyta\u0144 DAX bezpo\u015brednio, bez konieczno\u015bci tworzenia miar w modelu. Mo\u017cesz tam u\u017cywa\u0107 s\u0142owa kluczowego EVALUATE do eksploracji danych, testowania logiki i nauki sk\u0142adni DAX. Jest to doskona\u0142e narz\u0119dzie do debugowania i prototypowania.'];
    const incorrectFeedback = [{}, {'GLOBALNE': '\u274c **Niepoprawne!**\nUstawienia dotycz\u0105ce \u0142adowania danych i Power Query dla konkretnego pliku znajduj\u0105 si\u0119 w sekcji BIE\u017b\u0104CY PLIK, nie GLOBALNE. Ustawienia GLOBALNE dotycz\u0105 wszystkich plik\u00f3w Power BI.', 'Power Query': '\u274c **Niepoprawne!**\nNie ma sekcji Power Query w opcjach. Ustawienia dotycz\u0105ce automatycznego wykrywania typ\u00f3w znajduj\u0105 si\u0119 w sekcji zwi\u0105zanej z \u0142adowaniem danych do modelu.'}, {'Widok Raport': '\u274c **Niepoprawne!**\nWidok Raport s\u0142u\u017cy do tworzenia wizualizacji i uk\u0142adania element\u00f3w na stronach raportu. Nie pozwala na bezpo\u015brednie wykonywanie zapyta\u0144 DAX z u\u017cyciem EVALUATE.', 'Widok Dane': '\u274c **Niepoprawne!**\nWidok Dane umo\u017cliwia przegl\u0105danie zawarto\u015bci tabel i tworzenie kolumn kalkulowanych, ale nie pozwala na wykonywanie zapyta\u0144 z EVALUATE i testowanie wyra\u017ce\u0144 DAX w trybie zapyta\u0144.'}];
...
"
```
            lineageTag: 3eea08d4-c028-4041-a19d-78a69343b938
...
"
```
            lineageTag: 06e0e0bd-42c8-4869-845b-d43fc8f8f74a
...
"
```
            lineageTag: dbb6dce1-6b5e-475d-9986-7ff556f77fe4
...
<div class='container' id='viz_6b285173'>
    ...
    <div class='page active'>
        ...
        <pre><code>DAX
        <span class='dax-function'>SUMX</span>(&lt;tabela&gt;, &lt;wyrażenie&gt;)</code></pre>
...
"
```
            lineageTag: 1b7ca018-aab6-4fa6-891e-f2b64c78c0d7
...
"
```
            lineageTag: 04d2350a-bf52-417a-a414-a6d265314423
...
"
```
            lineageTag: 71f24055-e44d-438b-ae47-117e730f73cf
...
"
```
            lineageTag: 5c74d17d-32cc-45b2-a0ee-36e9a9210a64
...
<div class='container'>
    ...
    <div>
        ...
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Tabela z apostrofem[Kwota Netto]'>Tabela z apostrofem[Kwota Netto]</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Tabela i cudzysłów[Kwota Netto]'>Tabela i cudzysłów[Kwota Netto]</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='[Tabela Sprzedaży].[Kwota Netto]'>[Tabela Sprzedaży].[Kwota Netto]</span>
    </div>
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='IF, THEN, ELSE'>IF, THEN, ELSE</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='IF, wartość_prawda, wartość_fałsz'>IF, wartość_prawda, wartość_fałsz</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='CASE, WHEN, ELSE'>CASE, WHEN, ELSE</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='SWITCH, TRUE, FALSE'>SWITCH, TRUE, FALSE</span>
    </div>
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Plus'>Plus</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Ampersand'>Ampersand</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Podwójny pipe'>Podwójny pipe</span>
...
"
```
            lineageTag: 6373ff84-5190-4ba2-b78d-f4dd7138ed38
...
"
```
            lineageTag: 5acd5507-4dc0-4ad8-9923-c366d19ec45d
...
"
```
            lineageTag: 1edcbadc-b9d6-4b1b-a167-924a510d45c0
...
"
```
            lineageTag: 04247a43-b283-4af3-9cf3-52f5cda488d5
...
"
```
            lineageTag: 0b3ac118-dc9e-4da0-ab17-a673336adec1
...
"
```
            lineageTag: e3fd3d8f-7c6b-4bf7-b400-3956ce485926
...
"
```
            lineageTag: 1e745ec8-e156-4fd7-8ed6-ef4170583b76
...
"
```
            lineageTag: cdde4260-94f9-4ba5-91f2-a197c8c81bf0
...
"
```
            lineageTag: c4b790ef-dde1-42c2-9110-371b410a335e
...
"
```
            lineageTag: dc4c06f0-f46e-4710-9967-2105b91ae76e
...
"
```
            lineageTag: a40534c0-23c2-489d-8a6d-880bab30fd28
...
"
```
            lineageTag: bc82012f-c0ca-494c-90b6-4d35a8df6630
...
"
```
            lineageTag: 66093f22-f786-4a87-934e-91c74a4dc004
...
"
```
            lineageTag: 3ca8e397-727a-4c70-928d-0cbc2f44286f
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='CALCULATE, [Sprzedaż Netto], dKategorie[Kategoria] = NAPOJE'>CALCULATE, [Sprzedaż Netto], dKategorie[Kategoria] = NAPOJE</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='SUM, Sprzedaż[Wartość], WHERE Kategoria = NAPOJE'>SUM, Sprzedaż[Wartość], WHERE Kategoria = NAPOJE</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='FILTER, [Sprzedaż Netto], NAPOJE'>FILTER, [Sprzedaż Netto], NAPOJE</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='SUMIF, dKategorie[Kategoria], NAPOJE'>SUMIF, dKategorie[Kategoria], NAPOJE</span>
    </div>
...
"
```
            lineageTag: bca1eba5-5007-4d15-b024-95f18f8c9168
...
"
```
            lineageTag: b2537f7f-70e8-4c3f-b4dd-e2e5cea4f9c6
...
"
```
            lineageTag: 313df24a-cc6a-453a-85b0-ccbf47aca9f5
...
"
```
            lineageTag: 894daa36-07ad-42df-87b3-2aadaf6e42ec
...
"
```
            lineageTag: 0faf849f-2929-4e43-b391-0ff67cbb71f6
...
"
```
            lineageTag: c9978a69-4814-4e8f-b8f7-d59618424a4b
...
"
```
            lineageTag: 911008e5-a227-4a05-af72-f5a93ae6959c
...
"
```
            lineageTag: c8e5f90f-3b79-40e5-87e1-8dde955d0176
...
"
```
            lineageTag: 1fac1f96-8b38-481c-86ba-358a58173a66
...
"
```
            lineageTag: 5f8cc99c-356f-4707-9506-85842b518230
...
"
```
            lineageTag: c7d7e907-c9c6-44a3-bd4c-a9f8c0d37d14
...
"
```
            lineageTag: 00a42276-f292-49bf-b0e9-852728822522
...
<script>
    ...
    const incorrectFeedback = [{'LET, IN': '\u274c **Niepoprawne!**\nTo sk\u0142adnia u\u017cywana w innych j\u0119zykach (np. Power Query/M), nie w DAX. W DAX u\u017cywamy `VAR` do deklaracji zmiennych i `RETURN` do zwracania wyniku.', 'DECLARE, SELECT': '\u274c **Niepoprawne!**\nTo sk\u0142adnia SQL, nie DAX. W DAX zmienne tworzymy za pomoc\u0105 `VAR`, a wynik zwracamy przez `RETURN`.', 'SET, GET': '\u274c **Niepoprawne!**\nTo nie jest sk\u0142adnia DAX. Zmienne w DAX deklarujesz s\u0142owem `VAR`, a zwracasz wynik s\u0142owem `RETURN`.'}, {'Raz przed iteracj\u0105': '\u274c **Niepoprawne!**\nTo prawda dla zmiennych VAR PRZED funkcj\u0105 iteracyjn\u0105 (poza ni\u0105), ale zmienne WEWN\u0104TRZ SUMX s\u0105 obliczane na nowo dla ka\u017cdego wiersza. Ka\u017cda iteracja ma w\u0142asny kontekst wiersza i w\u0142asne warto\u015bci zmiennych.', 'Tylko pierwszy wiersz': '\u274c **Niepoprawne!**\nVAR jest obliczany dla ka\u017cdego wiersza osobno, nie tylko dla pierwszego. Dzi\u0119ki temu mo\u017cesz mie\u0107 r\u00f3\u017cne warto\u015bci zmiennej w r\u00f3\u017cnych iteracjach.', 'B\u0142\u0105d': '\u274c **Niepoprawne!**\nVAR mo\u017cna (i nale\u017cy!) u\u017cywa\u0107 wewn\u0105trz funkcji iteracyjnych. To standardowa i zalecana praktyka zwi\u0119kszaj\u0105ca czytelno\u015b\u0107 kodu.'}, {'Tylko \u015arednia': '\u274c **Niepoprawne!**\n`\u015arednia` jest obliczana raz (poza iteracj\u0105), ale `Warto\u015b\u0107` jest obliczana wielokrotnie (wewn\u0105trz SUMX dla ka\u017cdego wiersza). Obie zmienne maj\u0105 r\u00f3\u017cn\u0105 cz\u0119stotliwo\u015b\u0107 oblicze\u0144.', 'Obie': '\u274c **Niepoprawne!**\n`Warto\u015b\u0107` jest obliczana dla ka\u017cdego wiersza (wewn\u0105trz SUMX), ale `\u015arednia` jest obliczana tylko raz (poza iteracj\u0105) i ma sta\u0142\u0105 warto\u015b\u0107.', '\u017badna': '\u274c **Niepoprawne!**\nObie zmienne s\u0105 obliczane, ale z r\u00f3\u017cn\u0105 cz\u0119stotliwo\u015bci\u0105: `\u015arednia` raz, `Warto\u015b\u0107` dla ka\u017cdego wiersza.'}, {'SELECT': '\u274c **Niepoprawne!**\n`SELECT` to sk\u0142adnia SQL, nie DAX. W DAX Query View u\u017cywamy `EVALUATE` do wykonywania zapyta\u0144.', 'QUERY': '\u274c **Niepoprawne!**\nNie ma s\u0142owa kluczowego `QUERY` w DAX. Do rozpoczynania zapyta\u0144 s\u0142u\u017cy `EVALUATE`.', 'BEGIN': '\u274c **Niepoprawne!**\n`BEGIN` nie jest s\u0142owem kluczowym w DAX Query View. Zapytania rozpoczynaj\u0105 si\u0119 od `EVALUATE`.'}, {'Zwr\u00f3ci ostatni\u0105 zmienn\u0105': '\u274c **Niepoprawne!**\nDAX nie zgaduje co zwr\u00f3ci\u0107. Bez jawnego `RETURN` kod spowoduje b\u0142\u0105d sk\u0142adniowy. Musisz explicite okre\u015bli\u0107 wynik za pomoc\u0105 RETURN.', 'Zwr\u00f3ci sum\u0119': '\u274c **Niepoprawne!**\nDAX nie wykonuje \u017cadnych domy\u015blnych operacji. Bez `RETURN` kod jest niepoprawny sk\u0142adniowo i zako\u0144czy si\u0119 b\u0142\u0119dem.', 'Automatycznie doda': '\u274c **Niepoprawne!**\nDAX nie dodaje automatycznie RETURN. Musisz jawnie okre\u015bli\u0107 co zwr\u00f3ci\u0107. Brak RETURN to b\u0142\u0105d sk\u0142adniowy.'}, {'Tworzy w modelu': '\u274c **Niepoprawne!**\n`DEFINE MEASURE` NIE dodaje miary do modelu - tworzy tylko tymczasow\u0105 miar\u0119 dla tego zapytania. Model pozostaje niezmieniony. To spos\u00f3b na testowanie bez wp\u0142ywu na model danych.', 'Zmienia warto\u015b\u0107': '\u274c **Niepoprawne!**\n`DEFINE MEASURE` nie zmienia istniej\u0105cych miar - definiuje now\u0105, tymczasow\u0105 miar\u0119 na czas trwania zapytania.', 'Usuwa': '\u274c **Niepoprawne!**\n`DEFINE MEASURE` nie usuwa niczego - tworzy tymczasow\u0105 definicj\u0119 miary do u\u017cycia w zapytaniu.'}, {'Wydajno\u015b\u0107': '\u274c **Niepoprawne!**\n`ROW()` nie zwi\u0119ksza wydajno\u015bci - s\u0142u\u017cy do konwersji warto\u015bci skalarnej na format tabelaryczny, kt\u00f3ry jest wymagany przez EVALUATE.', 'Wymagane przed EVALUATE': '\u274c **Niepoprawne!**\n`ROW()` jest u\u017cywane po EVALUATE, nie przed. Mo\u017cna u\u017cywa\u0107 r\u00f3\u017cnych funkcji zwracaj\u0105cych tabele (SUMMARIZECOLUMNS, VALUES, itp.). ROW jest potrzebne gdy chcesz zwr\u00f3ci\u0107 pojedyncz\u0105 warto\u015b\u0107.', 'Konwersja typ\u00f3w': '\u274c **Niepoprawne!**\n`ROW()` nie konwertuje typ\u00f3w danych - tworzy tabel\u0119 z jednym wierszem. Jest to wymagane, bo EVALUATE przyjmuje tylko wyra\u017cenia tabelaryczne.'}];
...
"
```
            lineageTag: d236abdd-e340-4216-a4bf-dddc40f4d709
...
"
```
            lineageTag: 6aecfc7e-44f7-4302-aba1-4ec96c4bb2b1
...
"
```
            lineageTag: 97f84cdf-4e6f-43d4-a64e-3fe619664d73
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='SUMMARIZE z ADDCOLUMNS i FILTER'>SUMMARIZE z ADDCOLUMNS i FILTER</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='SUMMARIZECOLUMNS'>SUMMARIZECOLUMNS</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='CROSSJOIN z NATURALLEFTOUTERJOIN'>CROSSJOIN z NATURALLEFTOUTERJOIN</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='VALUES z CALCULATE'>VALUES z CALCULATE</span>
    </div>
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Automatycznie obsługuje kombinacje wymiarów z różnych tabel faktów'>Automatycznie obsługuje kombinacje wymiarów z różnych tabel faktów</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Działa tylko z jedną tabelą faktów'>Działa tylko z jedną tabelą faktów</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Wymaga ręcznego CROSSJOIN'>Wymaga ręcznego CROSSJOIN</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Jest szybsze od SUMMARIZE'>Jest szybsze od SUMMARIZE</span>
    </div>
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Gdy potrzebujesz tylko istniejących kombinacji bez miar'>Gdy potrzebujesz tylko istniejących kombinacji bez miar</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Gdy potrzebujesz obliczyć miary'>Gdy potrzebujesz obliczyć miary</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Gdy pracujesz z wieloma tabelami faktów'>Gdy pracujesz z wieloma tabelami faktów</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Nigdy - zawsze używaj SUMMARIZECOLUMNS'>Nigdy - zawsze używaj SUMMARIZECOLUMNS</span>
    </div>
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Usuwa wiersze z pustymi wartościami miar'>Usuwa wiersze z pustymi wartościami miar</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Sortuje wyniki alfabetycznie'>Sortuje wyniki alfabetycznie</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Tworzy indeksy na kolumnach'>Tworzy indeksy na kolumnach</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Konwertuje typy danych'>Konwertuje typy danych</span>
    </div>
...
<div class='container'>
    ...
    <div>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Jest skomplikowane i wymaga ręcznego łączenia wyników'>Jest skomplikowane i wymaga ręcznego łączenia wyników</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Jest zbyt wolne'>Jest zbyt wolne</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Nie działa z wieloma tabelami'>Nie działa z wieloma tabelami</span>
        <span class='function-chip' draggable='true' ondragstart='drag(event)' data-function='Jest przestarzałe i nieobsługiwane'>Jest przestarzałe i nieobsługiwane</span>
    </div>
...
"
```
            lineageTag: 0f08de30-d71e-4907-8511-0d126bdf2e52
...
"
```
            lineageTag: ce89e504-8ca2-43f0-8a75-059efbfbf4ff
...
<div class='container' id='viz_6b285173'>
    ...
    <div class='navigation'>
        <button id='prevBtn_6b285173' onclick='changePage_6b285173(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Strona <span id='currentPage_6b285173'>1</span> z <span id='totalPages_6b285173'>6</span>
        </span>
        <button id='nextBtn_6b285173' onclick='changePage_6b285173(1)'>Następna →</button>
    </div>
    ...
    <div class='page active'>
        ...
        <p>✅ <strong>Funkcje iteracyjne (SUMX, AVERAGEX):</strong></p>
        <ul>
        ...
        <p>❌ <strong>Zwykłe funkcje agregujące (SUM, AVERAGE):</strong></p>
        <ul>
        ...
        <li>Gdy standardowa SUM/AVERAGE nie wystarcza</li>
        </ul>
    ...
    <!-- Strona 3 -->
    <div class='page'>
        <h1>Porównanie: SUMX vs zwykła SUM</h1>
...
"
```
            lineageTag: 4b4d126a-97d1-44af-bef1-20df84bb971f

        measure '07a. Quiz - Funkcje iteracyjne w DAX' = ```
"
...
<div class='container' id='viz_ea38994d'>
    <!-- Nawigacja na górze -->
    <div class='navigation'>
        <button id='prevBtn_ea38994d' onclick='changePage_ea38994d(-1)'>← Poprzednia</button>
        <span class='page-indicator'>
            Strona <span id='currentPage_ea38994d'>1</span> z <span id='totalPages_ea38994d'>4</span>
        </span>
        <button id='nextBtn_ea38994d' onclick='changePage_ea38994d(1)'>Następna →</button>
    </div>
    ...
    <div class='page active'>
        ...
        <ul>
        <li>A) Najpierw sumują całą kolumnę, a potem wykonują obliczenia</li>
        <li>B) Wykonują obliczenia dla każdego wiersza tabeli osobno, a następnie agregują wyniki</li>
        <li>C) Działają tylko na kolumnach liczbowych</li>
        <li>D) Nie wymagają podania nazwy tabeli jako pierwszego argumentu</li>
        </ul>
    ...
    <div class='page'>
        <p>correct: 1</p>
        <p>explanation: Funkcje iteracyjne przechodzą przez każdy wiersz tabeli i wykonują obliczenia dla każdego wiersza osobno, a dopiero potem wykonują agregację. To odróżnia je od zwykłych funkcji agregujących.</p>
    ...
    <div class='page'>
        ...
        <ul>
        <li>A) Funkcja SUM nie obsługuje mnożenia</li>
        <li>B) Brakuje kontekstu filtra w formule</li>
        <li>C) Funkcja sumuje osobno ceny i ilości, a następnie mnoży sumy zamiast mnożyć wartości w każdym wierszu</li>
        <li>D) Należy użyć funkcji CALCULATE zamiast SUM</li>
        </ul>
    ...
    <div class='page'>
        <p>correct: 2</p>
        <p>explanation: SUM najpierw sumuje wszystkie ceny i wszystkie ilości osobno, a dopiero potem mnoży te sumy. To daje zupełnie inny wynik niż mnożenie ceny i ilości w każdym wierszu, a następnie sumowanie tych wyników.</p>
        <p>---</p>
...
(function() {
    ...
    window['showPage_ea38994d'] = function(n) {
        if (n > totalPages) currentPage_ea38994d = totalPages;
        if (n < 1) currentPage_ea38994d = 1;

        for (var i = 0; i < pages.length; i++) {
            pages[i].classList.remove('active');
        }
        pages[currentPage_ea38994d - 1].classList.add('active');

        document.getElementById('currentPage_' + vizId).textContent = currentPage_ea38994d;
        document.getElementById('prevBtn_' + vizId).disabled = (currentPage_ea38994d === 1);
        document.getElementById('nextBtn_' + vizId).disabled = (currentPage_ea38994d === totalPages);
    };

    window['changePage_ea38994d'] = function(n) {
        currentPage_ea38994d += n;
        window['showPage_ea38994d'](currentPage_ea38994d);
    };

    // Inicjalizacja
    window['showPage_ea38994d'](1);
...
"
```
            lineageTag: ca1e8131-2336-4f77-a71b-2d0646c87327
...
<head>
    <meta charset='UTF-8'>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
    <title>Quiz: Funkcje iteracyjne w DAX</title>
    <style>
    * {
                margin: 0;
                padding: 0;
...
"
```
            lineageTag: 7c3ee8d3-e408-47f8-bd2e-79481d9ec433
...
<div class='container' id='viz_0f635f43'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage_0f635f43'>1</span> z <span id='totalPages_0f635f43'>1</span>
        </span>
...
"
```
            lineageTag: b2c04f01-91f9-4d87-b090-1b849624c52b
...
<div class='container' id='viz_a9f5fb4f'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage_a9f5fb4f'>1</span> z <span id='totalPages_a9f5fb4f'>1</span>
        </span>
...
"
```
            lineageTag: 83563332-afee-4bd8-ac67-1d5e8e606627
...
<div class='container' id='viz_21ff4c70'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage_21ff4c70'>1</span> z <span id='totalPages_21ff4c70'>1</span>
        </span>
...
"
```
            lineageTag: 25a1c2ba-4e4d-4da3-9fd4-86ccfe5e1e38
...
<div class='container' id='viz_acb50efd'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage_acb50efd'>1</span> z <span id='totalPages_acb50efd'>1</span>
        </span>
...
"
```
            lineageTag: 16dd6c28-fdfd-4415-9855-9345c1e301ab
...
<div class='container' id='viz_b3458b19'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage_b3458b19'>1</span> z <span id='totalPages_b3458b19'>1</span>
        </span>
...
"
```
            lineageTag: 3186dd3c-31b6-4e7b-a0c9-349bb64d9c12
...
"
```
            lineageTag: efe58bfb-931c-4bca-a0b3-eec56bf42f67
...
<div class='container' id='viz_41750251'>
    ...
    <div class='navigation'>
        ...
        <span class='page-indicator'>
            Strona <span id='currentPage_41750251'>1</span> z <span id='totalPages_41750251'>1</span>
        </span>
...
"
```
            lineageTag: 895f9f19-fb16-40a0-90fc-678f61a51fdf
